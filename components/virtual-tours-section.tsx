...
export function VirtualToursSection() {
  const monasteries = [
    ...
    },
    {
      ...
      location: "Gangtok City",
      description: "City-based monastery rich in festivals with easy media access",
      image: "/EncheyGonpa.jpg",
      features: ["Urban location", "Regular festivals", "Easy Access"],
    },
    {
      name: "Ralang Monastery",
      location: "South Sikkim",
      description: "Large monastery with historic murals hosting Pang Lhabsol festival",
      image: "/Ralong_monastery.jpg",
      features: ["Historic Murals", "Festival Venue", "Art Gallery"],
    },
    {
      name: "Dubdi Monastery",
      location: "West Sikkim",
      description: "Oldest Monastery in Sikkim with deep historical value and rare manuscripts",
      image: "/Dubdi_Monastery.jpg",
      features: ["Historical Documents", "Rare Manuscripts ", "Ancient Architecture"],
    },
  ]
